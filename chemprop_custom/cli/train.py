...
from chemprop_custom.cli.common import (
    add_common_args,
    find_models,
    process_common_args,
    validate_common_args,
)
from chemprop_custom.cli.conf import CHEMPROP_TRAIN_DIR, NOW
from chemprop_custom.cli.utils import (
    LookupAction,
    Subcommand,
...
from chemprop_custom.cli.utils.args import uppercase
from chemprop_custom.data import (
    MoleculeDataset,
    MolGraphDataset,
...
from chemprop_custom.data.datasets import _MolGraphDatasetMixin
from chemprop_custom.models import MPNN, MulticomponentMPNN, save_model
from chemprop_custom.nn import AggregationRegistry, LossFunctionRegistry, MetricRegistry, PredictorRegistry
from chemprop_custom.nn.message_passing import (
    AtomMessagePassing,
    BondMessagePassing,
    MulticomponentMessagePassing,
)
from chemprop_custom.nn.transforms import GraphTransform, ScaleTransform, UnscaleTransform
from chemprop_custom.nn.utils import Activation
from chemprop_custom.utils import Factory
...
def add_train_args(parser: ArgumentParser) -> ArgumentParser:
    ...
    train_args.add_argument(
        "--rationale-balance",
        action="store_true",
        help="Ensures that the ratio of positive to negative samples in the training set is the same as the ratio of positive to negative samples in the rationale set.",
    )
...
def main(args):
    ...
    for replicate_idx, (train_data, val_data, test_data) in enumerate(zip(*splits)):
        ...
        train_loader = build_dataloader(
            ...
            rationale_balance=args.rationale_balance,
            seed=args.data_seed,
        )
