...
class Datum(NamedTuple):
    ...
    rationales: np.ndarray | None
    plausibility: np.ndarray | None
...
class MoleculeDataset(_MolGraphDatasetMixin, MolGraphDataset):
    ...
    def __getitem__(self, idx: int) -> Datum:
        ...
        return Datum(mg, self.V_ds[idx], self.X_d[idx], self.Y[idx], d.weight, d.lt_mask, d.gt_mask, d.rationales[idx], d.plausibility[idx])
